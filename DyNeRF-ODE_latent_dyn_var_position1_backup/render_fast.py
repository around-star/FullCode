...
from load_blender_fast import load_blender_data
import numpy as np
...
def render_path_extrapolate(args, render_poses, rnn_model, render_times, hwf, latent_store, chunk, render_kwargs, gt_imgs=None, savedir=None,
    ...
    #for j, frame_time in enumerate(render_times[3:]):
        ...
        #print(latents.shape)
        latent_nexts, _ = rnn_model.next_latent(None, None,
...
def create_nerf(args):
    ...
    latent_ode_model = create_LatentODE_model(512, z0_prior, 0.01, device, num_frames=args.num_frames+1, time_invariant=False)
...
def train():
    ...
    if args.render_only or True:
        ...
        latent_store = None
        #vid_ode_model.load_state_dict(torch.load('logs_single_vpt_big_pendulam_nODE_sample_size_75_org_time_huber_d_1_lr_1e-2/pitcher_base/020000.tar')['vid_ode'])
        nerf_state_dict = torch.load('/hdd5/hiran/NeRF_ODE/DyNeRF-ODE_latent_wo_encdec/logs_damp_once_together/nODE_sample_size_100_euler_all_pred_one_loss_warmup_tvar/pitcher_base/325000.tar')
