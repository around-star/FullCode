...
def create_LatentODE_model(input_dim, z0_prior, obsrv_std, device, 
    ...
    embed_damp, damping_dim = get_embedder(10, 1, 0)
    latent_embedder_out_dim = 512 + damping_dim
    ...
    decoder = Decoder(latents, decoder_output_dim).to(device)
