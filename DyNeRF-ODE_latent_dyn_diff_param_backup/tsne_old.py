...
def train():
    ...
    load_dict = torch.load('/hdd5/hiran/NeRF_ODE/DyNeRF-ODE_latent_dyn/logs_damp_once_together/nODE_sample_size_100_euler_all_pred_one_loss_warmup/pitcher_base/190000.tar')#["network_fine_state_dict"]
    ...
    tsne_results_total = tsne.fit_transform(total_latents)
    ...
    #plt.scatter(tsne_true_results[:,0], tsne_true_results[:,1], label='NeRF', c='g')
    plt.title('t-SNE Visualization')
    plt.xlabel('Dimension 1')
    plt.ylabel('Dimension 2')
    plt.legend(handles=legend_elements, loc="best")
    plt.savefig('tsne_damp_once_together/nODE_sample_size_100_euler_all_pred_one_loss_warmup.png')
