...
def config_parser():
    ...
    parser.add_argument('--sample_size', type=int, default=75, help="Number of time points to sub-sample")
...
def train():
    ...
    if args.dataset_type == 'blender':
        ...
        dataloaders, times, render_poses, render_times, hwf, bds = load_llff_data(args, args.datadir, start_frame=0, end_frame=75, device=device)
