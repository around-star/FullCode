...
def config_parser():
    ...
    parser.add_argument('--sample_size', type=int, default=80, help="Number of time points to sub-sample")
...
def train():
    ...
    if args.render_only or True:
        ...
        nerf_state_dict = torch.load('/hdd5/hiran/NeRF_ODE/DyNeRF-ODE_latent_dyn/logs_ball_roll_together/sample_size_100_euler_all_pred_warmup_n_obs_2/pitcher_base/110000.tar')
        ...
        with torch.no_grad():
            ...
            testsavedir = os.path.join(basedir, expname, 'renderonly_{}_{:06d}_extrap2'.format('test' if args.render_test else 'path', start))
