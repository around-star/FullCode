...
from load_nsff import load_llff_data
import numpy as np
...
def train():
    ...
    if args.dataset_type == 'blender':
        ...
        dataloaders, times, render_poses, render_times, hwf, bds = load_llff_data(args, args.datadir, start_frame=0, end_frame=3000, final_height=288, skip=3, device=device)
    ...
    if args.render_only or True:
        ...
        nerf_state_dict = torch.load('/hdd5/hiran/NeRF_ODE/DyNeRF-ODE_latent_dyn_multi_cam/logs_flame_steak/ss_80_euler_all_pred_warmup_n_obs_2_latents2/pitcher_base/185000.tar')
        ...
        with torch.no_grad():
            ...
            testsavedir = os.path.join(basedir, expname, 'renderonly_{}_{:06d}_extrap_dynamic_pose_10_ckpt_185k'.format('test' if args.render_test else 'path', start))
