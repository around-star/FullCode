...
def config_parser():
    ...
    parser.add_argument('--sample_size', type=int, default=300, help="Number of time points to sub-sample")
...
def train():
    ...
    if args.dataset_type == 'blender':
        ...
        dataloaders, times, render_poses, render_times, hwf, bds = load_llff_data(args, args.datadir, start_frame=0, end_frame=3000, final_height=288, skip=1, device=device)
    ...
    #min_time, max_time = times[0,0], times[0,-1]
    ...
    for i in trange(start, N_iters):
        ...
        # Rest is logging
        if i%args.i_weights==0 and i >= 10000:
